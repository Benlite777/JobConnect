...
urlpatterns = [
    ...
    path('abouts/', views.single_job_view, name='abouts'),
    ...
    path('negotiation-tips/', views.salary_negotiation_tips, name='salary_negotiation_tips'),
    path('download-resume/<int:applicant_id>/', views.download_resume, name='download-resume'),
    path('job/<int:job_id>/', views.job_detail, name='job-detail'),
    path('applicant/<int:applicant_id>/select/', views.select_applicant, name='select-applicant'),
    path('applicant/<int:applicant_id}/reject/', views.reject_applicant, name='reject-applicant'),
